...
export default function RecomendadoPage({ libro }) {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#FAF7F0", fontFamily: "DM Sans, sans-serif", color: "#1F2937" }}>
      <Head>
        <title>{libro.titulo} - Recomendado para católicos - Catolicum</title>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
              ...
              {libro.amazon_url && (
                <div style={{ background: "#1F3A5F", borderRadius: 12, padding: "1.5rem", textAlign: "center" }}>
                  ...
                  <p style={{ fontSize: 11, color: "#3A5A7A", marginTop: 8 }}>Enlace de afiliado · Católicum recibe una pequeña comisión para seguir con este proyecto sin ningún coste para ti</p>
                </div>
              )}
