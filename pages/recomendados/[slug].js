...
export async function getStaticPaths() {
  ...
  var paths = libros
    ...
    .map(function(b) { return { params: { slug: toSlug(b.titulo) } }; });
  ...
  return (
    <div style={{ minHeight: "100vh", background: "#FAF7F0", fontFamily: "DM Sans, sans-serif", color: "#1F2937" }}>
      <Head>
        ...
        <meta name="keywords" content={libro.titulo + ", " + libro.autor + ", libro católico recomendado"} />
          ...
          <div style={{ maxWidth: 720, margin: "0 auto", padding: isMobile ? "1.25rem 1rem" : "2.5rem 1.5rem", width: "100%" }}>
            ...
            <div style={{ display: "flex", gap: 24, marginTop: "1.5rem", marginBottom: "2rem", alignItems: "flex-start", flexDirection: isMobile ? "column" : "row" }}>
              <div style={{ flexShrink: 0 }}>
                {coverUrl ? (
                  ...
                  <div style={{ width: isMobile ? 120 : 140, height: isMobile ? 180 : 210, borderRadius: 8, background: "#EDF2F8", border: "0.5px solid #C8D4E0", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <svg width="32" height="32" viewBox="0 0 64 64"><rect width="64" height="64" rx="14" fill="#2A4E7F"/><rect x="8" y="14" width="21" height="34" rx="3" fill="#16263F"/><rect x="10" y="16" width="17" height="30" rx="2" fill="#8AAFD4"/><rect x="30" y="14" width="21" height="34" rx="3" fill="#B8922A"/><rect x="32" y="16" width="17" height="30" rx="2" fill="#F5E9C0"/><rect x="28" y="12" width="4" height="38" rx="2" fill="#0F1E30"/></svg>
                  </div>
                )}
              </div>
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 4 }}>
                  <span style={{ fontSize: 10, fontWeight: 500, textTransform: "uppercase", letterSpacing: ".07em", color: "#8AAFD4" }}>Puntuación Católicum</span>
                </div>
                ...
                {libro.amazon_url && (
                  <a href={libro.amazon_url} target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "10px 20px", background: "#1F3A5F", color: "#FAF7F0", borderRadius: 10, fontSize: 14, textDecoration: "none" }}>
                    Comprar en Amazon
                  </a>
                )}
              </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
              ...
              <div style={{ background: "#fff", border: "0.5px solid #C8D4E0", borderRadius: 12, padding: "1.25rem" }}>
                <p style={{ fontSize: 10, fontWeight: 500, textTransform: "uppercase", letterSpacing: ".07em", color: "#8AAFD4", marginBottom: 8 }}>Análisis doctrinal</p>
                <p style={{ fontSize: 14, color: "#3A3A3C", lineHeight: 1.75 }}>{libro.analisis}</p>
              </div>

              {libro.para_quien && (
                <div style={{ background: "#fff", border: "0.5px solid #C8D4E0", borderRadius: 12, padding: "1.25rem" }}>
                  <p style={{ fontSize: 10, fontWeight: 500, textTransform: "uppercase", letterSpacing: ".07em", color: "#8AAFD4", marginBottom: 8 }}>Para quién es este libro</p>
              ...
              {libro.momentos_vida && (
                <div style={{ background: "#EAF3DE", border: "0.5px solid #9FE1CB", borderRadius: 12, padding: "1.25rem" }}>
                  <p style={{ fontSize: 10, fontWeight: 500, textTransform: "uppercase", letterSpacing: ".07em", color: "#085041", marginBottom: 8 }}>Cuándo puede ayudarte</p>
              ...
              {libro.amazon_url && (
                <div style={{ background: "#1F3A5F", borderRadius: 12, padding: "1.5rem", textAlign: "center" }}>
                  ...
                  <a href={libro.amazon_url} target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 8, padding: "12px 28px", background: "#E1B955", color: "#1F3A5F", borderRadius: 10, fontSize: 15, textDecoration: "none", fontWeight: 500 }}>
                    Comprar en Amazon
                  </a>
