    ...
    <div style={{ minHeight: "100vh", background: "#FAF7F0", fontFamily: "DM Sans, sans-serif", color: "#1F2937" }}>
      ...
      <div style={{ display: "flex", minHeight: "100vh" }}>
        ...
        <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column" }}>
          ...
          {isMobile && (
            <div style={{ background: "#1F3A5F", borderBottom: "0.5px solid #2A4E7F", padding: "10px 16px", position: "sticky", top: 0, zIndex: 100 }}>
          ...
          <div style={{ maxWidth: 680, margin: "0 auto", padding: isMobile ? "1.25rem 1rem" : "2.5rem 1.5rem", width: "100%" }}>
            <p style={{ fontSize: 15, lineHeight: 1.75, color: "#3A3A3C", marginBottom: "1.5rem" }}>
              Católicum es una herramienta independiente pensada para ayudar a lectores católicos a conocer si un libro es compatible con la fe antes de leerlo. Y un club para debatirlo.
            </p>
