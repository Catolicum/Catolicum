      ...
      <div style={{ display: "flex", minHeight: "100vh" }}>
        ...
        <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column" }}>
            ...
            <p style={{ fontSize: 14, color: "#6E6E73", marginBottom: "2rem", lineHeight: 1.6 }}>
              Seleccion de libros compatibles o plenamente alineados con la fe catolica. Puntuacion 7 o superior.
            </p>
                ...
                {libros.map(function(b) {
                  ...
                  return (
                    <div key={b.t} style={{ display: "flex", alignItems: "center", gap: 12, background: "#FFFFFF", border: "0.5px solid #D1D1D6", borderRadius: 10, padding: ".75rem 1rem" }}>
                      <div style={{ width: 36, height: 36, borderRadius: "50%", background: st.bg, color: st.text, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 13, fontWeight: 500, flexShrink: 0 }}>
                        {b.s}
                      </div>
                      ...
                      <a href={url} target="_blank" rel="noopener noreferrer" style={{ fontSize: 12, padding: "5px 10px", border: "0.5px solid #D1D1D6", borderRadius: 6, color: "#3A3A3C", textDecoration: "none", flexShrink: 0, background: "#F5F5F7" }}>
                        Amazon
                      </a>
                    </div>
                  );
