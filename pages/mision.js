      ...
      <div style={{ display: "flex", minHeight: "100vh" }}>
        ...
        <div style={{ flex: 1, minWidth: 0, display: "flex", flexDirection: "column" }}>
          ...
          <div style={{ maxWidth: 680, margin: "0 auto", padding: isMobile ? "1.25rem 1rem" : "2.5rem 1.5rem", width: "100%" }}>
            <p style={{ fontSize: 15, lineHeight: 1.75, color: "#3A3A3C", marginBottom: "1.5rem" }}>Católicum nació de una necesidad real: ayudar a los católicos a navegar el mundo editorial con criterio de fe. Cada año se publican miles de libros, y no siempre es fácil saber cuáles son compatibles con la doctrina católica.</p>
            ...
            <p style={{ fontSize: 14, lineHeight: 1.7, color: "#3A3A3C", marginBottom: "1rem" }}>Más allá del análisis doctrinal, queremos ser un espacio de debate y comunidad. Por eso cada lector puede valorar los libros y dejar su opinión. Dos puntuaciones — la nuestra y la del club — generan el debate más honesto sobre qué leer con fe.</p>
            ...
            <p style={{ fontSize: 14, lineHeight: 1.7, color: "#3A3A3C", marginBottom: "2rem" }}>Católicum es un proyecto independiente y gratuito. Se financia mediante publicidad no intrusiva y enlaces de afiliado a librerías online. Toda la información que ofrecemos se basa en fuentes públicas y el juicio final siempre corresponde al lector.</p>

            <div style={{ background: "#EDF2F8", border: "0.5px solid #C8D4E0", borderRadius: 12, padding: "1.25rem", marginBottom: "2rem", display: "flex", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
              <div style={{ flex: 1, minWidth: 180 }}>
                <p style={{ fontFamily: "'EB Garamond', Georgia, serif", fontSize: 18, color: "#1F3A5F", marginBottom: 4 }}>¿Quieres participar?</p>
                <p style={{ fontSize: 13, color: "#6E6E73" }}>Únete al club y valora tus libros.</p>
              </div>
              <Link href="/club" style={{ display: "inline-flex", alignItems: "center", padding: "9px 18px", background: "#1F3A5F", color: "#FAF7F0", borderRadius: 8, fontSize: 13, textDecoration: "none", fontFamily: "DM Sans, sans-serif", fontWeight: 500, flexShrink: 0 }}>
                Ver el club →
              </Link>
            </div>
